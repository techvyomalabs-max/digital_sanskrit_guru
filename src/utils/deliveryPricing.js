...
export const PINCODE_PREFIX_COORDINATES = {
...
export const PINCODE_2DIGIT_COORDINATES = {
...
export function calculateIndiaPostCharge(distanceKm, items) {
...
export function getDeliveryPricingDetails(settings, shipping, items) {
  ...
  if (itemList.length > 0) {
    ...
    // If ALL items in the cart are digital (Web version, Kindle, E-book, PDF, etc.)
